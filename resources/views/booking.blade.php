        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    {{--@if(count($bookings_check_in) || count($bookings_check_out))--}}
                        {{--<span>phongf nay da duocj dat tu {{ $bookings_check_in }} den {{ $bookings_check_out }}</span>--}}
                    {{--@endif--}}
                    ...
                    <form action="{{ route('member_booking') }}" method="post" novalidate>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                <label class="ip_form">{{ __('Họ và Tên') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control form_readonly" value="{{ $rooms['name'] }}"
                                       readonly>
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="ip_form">{{ __('Số người') }}</label>
                                <input type="text" class="form-control form_readonly"
                                       value="{{ $rooms['copacity_room'] }}" readonly>
                            </div>
                        </div>
